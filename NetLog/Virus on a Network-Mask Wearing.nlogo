...
globals
[
  mask-use-probability
]


to setup
  clear-all
  set mask-use-probability 0.2
  setup-nodes
  setup-spatially-clustered-network
  ask n-of initial-outbreak-size turtles
    [ become-infected ]
  ask n-of initial-wearing-mask turtles
    [ become-wearing-mask ]
  ...
  ask turtles with [infected?]
    [
      ask link-neighbors with [not resistant?]
        [
          if wearing-mask? [
            ;; Se a tartaruga estiver usando máscara, a chance de infecção é reduzida
            if random-float 100 < virus-spread-chance * 0.3 ;;(1 - mask-effectiveness)
              [ become-infected ]
          ]
          if not wearing-mask? [
            ;; Se não estiver usando máscara, a chance de infecção é normal
